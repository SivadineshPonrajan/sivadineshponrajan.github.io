...
$('document').ready(function(){
	...
	$('#invite_friends').click(function(){
		 vw = $(window).width()/2;
		 mid = $(window).height()/2 + 120;

		 mid_diff = mid/12;
		 vw_diff = vw/12;
		$('#self').css({"display": "block", "width": "250px","height": "280px", "bottom":'0px',"left":vw+'px'});
		$('#self').animate({top:mid-mid_diff*4-30,left:vw-45},3000);

		$('#f1').css({"display": "block", "width": "80px","height": "250px",  "top":500*Math.random()+'px',"left":'0px'});
		$('#f1').animate({top:mid-mid_diff*3,left:vw-vw_diff*3+30},3000);


		$('#f2').css({"display": "block","width": "120px","height": "210px", "top":500*Math.random()+'px',"left":'0px'});
		$('#f2').animate({top:mid-mid_diff*3,left:vw+vw_diff*3-30},3000);


		$('#f3').css({"display": "block","width": "120px","height": "180px", "top":500*Math.random()+'px',"left":'0px'});
		$('#f3').animate({top:mid-mid_diff*2,left:vw-vw_diff*4-30},3000);

		$('#f4').css({"display": "block","width": "120px", "top":500*Math.random()+'px',"left":'0px'});
		$('#f4').animate({top:mid-mid_diff*2+20,left:vw+vw_diff*4-15},3000);

		$('#f5').css({"display": "block","width": "160px","height": "210px", "top":500*Math.random()+'px',"right":'0px'});
		$('#f5').animate({top:mid-mid_diff,left:vw+vw_diff*5+5},3000);

		$('#f6').css({"display": "block","width": "80px","height": "230px", "top":500*Math.random()+'px',"right":'0px'});
		$('#f6').animate({top:mid-mid_diff,left:vw-vw_diff*5-20},3000);

		$('#f7').css({"display": "block","width": "70px","height": "100px", "top":500*Math.random()+'px',"right":'0px'});
		$('#f7').animate({top:mid+90,left:vw-vw_diff*6-15},3000);


		$('#f8').css({"display": "block","width": "250px","height": "210px", "top":500*Math.random()+'px',"right":'0px'});
		$('#f8').animate({top:mid,left:vw+vw_diff*6-25},3000);
	...
	$('#cake_fadein').click(function(){
		$('#cake_pink').css({"display": "block", "top": '70%'});
		$('#candle').css({"display": "block", "top": '45%'});
	...
	$('#dj_time').click(function(){
		...
		$('#b6').attr('id','b66')
		$('#b7').attr('id','b77')
		var xx = ($(window).width()/2) - vw;
		$('#b11').animate({top:240, left: xx},500);
		$('#b22').animate({top:240, left: xx+vw-vw*2/3},500);
		$('#b33').animate({top:240, left: xx+vw-vw/3},500);
		$('#b44').animate({top:240, left: xx+vw},500);
		$('#b55').animate({top:240, left: xx+vw+vw/3},500);
		$('#b66').animate({top:240, left: xx+vw+vw*2/3},500);
		$('#b77').animate({top:240, left: xx+2*vw},500);
